        ...
        <div className="max-w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-3xl p-px bg-gradient-to-b from-blue-300 to-pink-300 dark:from-blue-800 dark:to-purple-800 ">
              <div className="rounded-[calc(1.5rem-1px)] p-12" style={{ background: '#0e0c15' }}>
                ...
                <h2 className="mt-6 font-semibold text-base sm:text-lg text-white">
                  Workflow Efficiency
                </h2>
                <p className="sm:mt-1 block text-sm sm:text-base text-gray-300"> Streamlined tasks and automated processes result in significant time and resource savings, enabling focus on high-value activities.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl p-px bg-gradient-to-b from-blue-300 to-pink-300 dark:from-blue-800 dark:to-purple-800 ">
              <div className="rounded-[calc(1.5rem-1px)] p-12" style={{ background: '#0e0c15' }}>
                ...
                <p className="sm:mt-1 block text-sm sm:text-base text-gray-300"> Achieves heightened operational efficiency through the optimization of workflows and business processes, leading to improved productivity and cost reduction.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl p-px bg-gradient-to-b from-blue-300 to-pink-300 dark:from-blue-800 dark:to-purple-800 ">
              <div className="rounded-[calc(1.5rem-1px)] p-12" style={{ background: '#0e0c15' }}>
                ...
                <p className="sm:mt-1 block text-sm sm:text-base text-gray-300">Facilitates informed and agile decision-making by translating complex data into valuable insights, positioning businesses for success in a competitive market.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl p-px bg-gradient-to-b from-blue-300 to-pink-300 dark:from-blue-800 dark:to-purple-800 ">
              <div className="rounded-[calc(1.5rem-1px)] p-12" style={{ background: '#0e0c15' }}>
                ...
                <h2 className="mt-6 font-semibold text-base sm:text-lg text-white">
                  Market Agility </h2>
                <p className="sm:mt-1 block text-sm sm:text-base text-gray-300">Ensures businesses stay agile and responsive to market changes with advanced analytics and actionable insights, enhancing the ability to quickly adapt strategies.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl p-px bg-gradient-to-b from-blue-300 to-pink-300 dark:from-blue-800 dark:to-purple-800 ">
              <div className="rounded-[calc(1.5rem-1px)] p-12" style={{ background: '#0e0c15' }}>
                ...
                <p className="sm:mt-1 block text-sm sm:text-base text-gray-300">Promotes collaboration across teams with a multi-user environment and fine-grained access control, improving project outcomes and innovation.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl p-px bg-gradient-to-b from-blue-300 to-pink-300 dark:from-blue-800 dark:to-purple-800 ">
              <div className="rounded-[calc(1.5rem-1px)] p-12" style={{ background: '#0e0c15' }}>
                ...
                <p className="sm:mt-1 block text-sm sm:text-base text-gray-300">Maintains high standards of security and compliance, protecting business data and ensuring operations adhere to regulatory requirements.
                </p>
              </div>
            </div>
          </div>
